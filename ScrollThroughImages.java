...
public class ScrollThroughImages {
...
public void beforeClass() throws MalformedURLException {
  ...
  public void imageScrollTest() throws InterruptedException {
   ...
   // Scroll to Helen's post
      driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).scrollForward().scrollTextIntoView(\"helen\")"));
      Thread.sleep(5000L);
   // Find the number of images shown after scrolling
      numberOfImages = driver.findElementsByXPath("//android.view.View/android.view.View/android.widget.Image");
      System.out.println("Number of image shown after scrolling: " + numberOfImages.size());
