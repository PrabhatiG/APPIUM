 ...
 public void beforeClass() throws MalformedURLException {
  ...
  public void smsTest() {
	...
	// Enter the number to send message to
	 String boxLocator= "resourceId(\"com.google.android.apps.messaging:id/recipient_text_view\")";
	 
	 //Enter the phone number
	 driver.findElement(MobileBy.AndroidUIAutomator(boxLocator)).sendKeys("1234567890");
